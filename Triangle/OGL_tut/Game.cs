...
namespace OGL_tut
{
    public class Game : GameWindow
    {
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            ImGui.Begin("Change Elsa");
            ImGui.SliderFloat("Scale Elsa", ref _scale, 0, 1);
            ImGui.SliderFloat("Spin Elsa", ref _angle, -3.14f, 3.14f);
            ImGui.SliderFloat("Spin Elsa on Z", ref _angleZ, -3.14f, 3.14f);
            ImGui.SliderFloat("Go away", ref _distanse, 1, 15.0f);
