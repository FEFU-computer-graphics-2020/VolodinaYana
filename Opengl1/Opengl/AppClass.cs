...
namespace Opengl
{
        public class AppClass : GameWindow
        {
            public AppClass(int width, int height, string title) : base(width, height, GraphicsMode.Default, title)
            {
        ...
        protected override void OnLoad(EventArgs e) // при загрузке
        {
            GL.ClearColor(0.7f, 0.345f, 0.3f, 1.0f);
        ...
        protected override void OnRenderFrame(FrameEventArgs e) //рисуем каждый кадр
        {
